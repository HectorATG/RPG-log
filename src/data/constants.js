...
export const DAILY_MISSIONS = [
  ...
  { id: 5, name: "30 min cardio",        desc: "Trota, salta o baila durante 30 minutos.",     stat: "RESISTENCIA",  icon: "🟦", color: "#5b8dd9", xp: 55, coins: 35, progress: 0, total: 30, unit: "min",   done: false, locationEvidenceEnabled: true, locationBonusXp: 25, locationBonusCoins: 10 },
  { id: 6, name: "Sprint de 100m",       desc: "Corre a máxima velocidad 100 metros.",         stat: "AGILIDAD",     icon: "🟩", color: "#52c97a", xp: 45, coins: 28, progress: 0, total: 3,  unit: "veces", done: false, locationEvidenceEnabled: true, locationBonusXp: 20, locationBonusCoins: 8  },
];
